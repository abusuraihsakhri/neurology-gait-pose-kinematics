"""
Pydantic v2 schemas and data definitions for Neurology Gait Pose Kinematics.
...
class SystemTaskPayload(BaseModel):
    ...
    @classmethod
    def reject_non_finite_metrics(cls, v: float) -> float:
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "neurology-gait-pose-kinematics"
